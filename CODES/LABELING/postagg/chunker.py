...
from postagg.probCalc import probability as PB
from postagg.tagger import Tagger
...
class Chunker:
	...
	def __init__(self):
		...
		self.TAGGER3.set_model_file('postagg/dataset/all_indo_man_tag_corpus_model.crf.tagger')
